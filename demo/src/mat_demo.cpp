...
int main() {
    ...
    auto light = directional_light(glm::vec3(100, 100, 100), 0.5f, glm::vec3(0, 1, 1), "rotating_light");
	...
	point_light inner_light(glm::vec3(0.3, 0.3, 1.0), 3.0f, glm::vec3(0, 1.8, 0), 10.0f, "inner_light");
    demo_world.add_point_light(&inner_light);
	...
	// Creating the camera
	camera* main_camera = new camera(glm::vec3(0, 10, -8), glm::vec3(0, 1.5, 0));
