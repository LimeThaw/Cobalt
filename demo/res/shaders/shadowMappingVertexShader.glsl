...
uniform mat4 shadow_map_view_projection_matrix;
...
out vec3 shadow_map_space_position;
...
void main() {
    ...
    shadow_map_space_position = (shadow_map_view_projection_matrix * world_position4).xyz;
