...
class simple_render_pass :
    ...
    public:
        simple_render_pass(shader_ptr new_shader, std::vector<std::shared_ptr<material>> render_materials);

        ///< Creating a render pass mith multiple materials.
        simple_render_pass(shader_ptr new_shader, std::shared_ptr<material> render_materials);
