...
simple_render_pass::simple_render_pass(shader_id new_shader_id, std::vector< unsigned int > render_material_ids) : render_pass< scene, camera, std::vector<directional_light>, std::vector<point_light>, glm::vec3 >(new_shader_id), render_material_ids(render_material_ids) {
}

simple_render_pass::simple_render_pass(shader_id new_shader_id, unsigned int render_material_id) : render_pass< scene, camera, std::vector<directional_light>, std::vector<point_light>, glm::vec3 >(new_shader_id), render_material_ids(std::vector<unsigned int> {render_material_id}) {
}
